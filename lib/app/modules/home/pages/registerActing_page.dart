...
class RegisterActingPage extends StatefulWidget {
  final String title;
  const RegisterActingPage({Key? key, this.title = 'RegisterActingPage'}) : super(key: key);
  @override
  RegisterActingPageState createState() => RegisterActingPageState();
}
class RegisterActingPageState extends State<RegisterActingPage> {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  const Text("Trabalho na Área da:"),
                  const SizedBox(height: 32),
                  SizedBox(
                        height: 300,
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          Modular.to.pushNamed('/registerInterest');
                        },
